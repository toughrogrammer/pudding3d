...
FlatTriangleRasterizer::FlatTriangleRasterizer()
{
...
void FlatTriangleRasterizer::drawTriangle( FrameBuffer* buffer, const Triangle& t ) 
{
	Vertex v1 = t.v(0);
	Vertex v2 = t.v(1);
	Vertex v3 = t.v(2);
...
void FlatTriangleRasterizer::drawLine(FrameBuffer* buffer, Vertex v1, Vertex v2 )
{
...
bool FlatTriangleRasterizer::ClipLine(FrameBuffer* buffer, Vector4 &p1, Vector4 &p2)
{
